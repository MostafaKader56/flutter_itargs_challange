...
class CustomLoadingIndicator2 extends StatefulWidget {
  const CustomLoadingIndicator2({super.key, this.size = 65});

  final double size;
  @override
  State<CustomLoadingIndicator2> createState() =>
      _CustomLoadingIndicator2State();
}

class _CustomLoadingIndicator2State extends State<CustomLoadingIndicator2>
